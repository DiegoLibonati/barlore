...
export const COCKTAIL_MOCK: CockTail = {
  idDrink: "17222",
  strDrink: "A1",
...
export const COCKTAIL_MOCK_2: CockTail = {
  idDrink: "13501",
  strDrink: "ABC",
  strCategory: "Shot",
  strAlcoholic: "Alcoholic",
...
export const COCKTAIL_MOCK_3: CockTail = {
  idDrink: "11023",
  strDrink: "Almeria",
...
export const COCKTAILS_MOCK: CockTail[] = [COCKTAIL_MOCK, COCKTAIL_MOCK_2];
export const COCKTAILS_MOCK_2: CockTail[] = [COCKTAIL_MOCK_3];

export const REQUEST_MOCK_SEARCH_F = { drinks: COCKTAILS_MOCK };
export const REQUEST_MOCK_SEARCH_S = { drinks: COCKTAILS_MOCK_2 };
export const REQUEST_MOCK_SEARCH_I = { drinks: COCKTAILS_MOCK_2 };
